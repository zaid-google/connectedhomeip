                                                               ...
                                                               CommandHandler * handler)
{
    ...
    case GeneralDiagnostics::Commands::TimeSnapshot::Id: {
        ...
        ReturnErrorOnFailure(request_data.Decode(input_arguments));
        return HandleTimeSnapshot(*handler, request.path, request_data, false);
    }
...
GeneralDiagnosticsCluster::HandleTestEventTrigger(const Commands::TestEventTrigger::DecodableType & commandData)
{
...
GeneralDiagnosticsCluster::HandleTimeSnapshot(CommandHandler & handler, const ConcreteCommandPath & commandPath,
...
std::optional<DataModel::ActionReturnStatus>
GeneralDiagnosticsCluster::HandlePayloadTestRequest(CommandHandler & handler, const ConcreteCommandPath & commandPath,
...
TestEventTriggerDelegate * GeneralDiagnosticsCluster::GetTriggerDelegateOnMatchingKey(ByteSpan enableKey)
{
...
bool GeneralDiagnosticsCluster::IsByteSpanAllZeros(const ByteSpan & byteSpan)
{
